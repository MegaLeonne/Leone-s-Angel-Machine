...
🌌 **[View Digital Codex](https://megaleonne.github.io/Leone-s-Angel-Machine/)** | 📋 **[Restoration Plan](../RESTORATION_PLAN.md)** | 🤝 **[Contribute](../guides/guide-contributing.md)**
...
- ⏳ **He Who Remains** upgraded to SEVENTH-BOUND steward of the Ash-Layers
- 🌫️ **The Veil** drawn over technical metadata (redirected to `/meta`)
- 🌀 **KHAOS NOTES** established as a landing zone for raw potential
- 🏛️ **Ash-Layer Protocol** implemented to consolidate and honor orphans
...
1. **[The Head / Witch Queen Archetype](./The-Head-Archetype.md)** — Start here to understand the organizing principle
...
- **[Complete Index](../index/INDEX.md)** — Full file map and navigation
- **[Seventh Borough Canon](../the-seventh-borough/CANON.md)** — Canonical workflow and tags
...
- **[Prophecy](../philosophy/philosophy-prophecy.md)** — Inevitability given language
- **[The Material](../philosophy/The Material.md)** — What we make together, when together willing
- **[Amnesia](../philosophy/Amnesia.md)** — Memory, forgetting, and erasure
- **[The Void](../philosophy/The Void.md)** — The conceptual realm
...
- **[The Head / Witch Queen](./The-Head-Archetype.md)** — Organizing principle, the Anchor, compassionate structure-keeper
- **[The Heart](./docs/archetypes/The-Heart.md)** — Burning aspect, twin to The Head

#### **Angels**

- **[Michael, The KlockWork Angel](./Angels/Michael, The KlockWork Angel.md)** — Archangel of Time, mechanized divinity
- **[Osiris, Arch Angel of Omen](./Angels/Osiris, Arch Angel Of Omen.md)** — Bearer of prophetic signs

#### **Devils & Shadow Figures**

- **[Taylor, Devil of Desire](./Devils/Taylor, Devil of Desire.md)** — Fallen angel of human duality
- **[The Blind](./Devils/The Blind.md)** — Prophet-fiend who sees harsh truth

#### **Composite Forms**

- **[Shadow-Demon-Providence](./Composite/Shadow-Demon-Providence.md)** — Trinity of self, fear, and grace
...
- **[Anchor Invocation](./The-Head-Archetype.md)** — Ritual for preserving personhood

### 🏛️ The Ash-Layer Protocol

Tending to the remains of previous cycles:

- **[REMNANTS (Witness Log)](../archive/REMNANTS.md)** — Master catalog of all ash-layers
- **[Ash-Layers](../archive/ash-layers/)** — Tended fragments of forgotten history

### The Orphan System

Fragmented ideas and generative seeds awaiting integration:

- **[Orphan Index](../archive/ash-layers/indices/OrphanIndex.md)** — Catalog of unbound fragments
...
│   ├── khaos/               # Raw potential (Khaos Notes)
│   ├── the-seventh-borough/ # Canon and workflow docs
│   ├── archive/             # Ash-Layers and REMNANTS
...
**[Full Contributing Guide →](../guides/guide-contributing.md)**
